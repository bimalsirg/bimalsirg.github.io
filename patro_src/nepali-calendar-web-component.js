/*
    ...
    ©copyright: BimalSirG YouTube Channel 
            ...
            <div class="calendar-head">
                ...
                <div class="cal-nav">
                    ...
                    <div class="cal-head-center">
                        <span class="cal-year"> <strong>२०७७/</strong><small>2020</small> </span><br>
                        <span class="month"><strong>भाद्र</strong></span><br>
                        <span class="int-month"><small>(August/September)</small></span><br>
        ...
        <small>☛</small><br><span style="font-size: 10px;">Next Month</span>
            ...
            <div class="calendar-body">
                <div class="week">
                    ...
                    <div class="days-name" style="color: red;">SAT</div>
                </div>
                <div class="days">
            ...
            <div class="calendar-footer">
                ...
                <div class="cal-foot-center" style="color: brown; font-weight: bold; padding-left: 5px; margin-left: 5px; font-size: 2 em;"><strong class="footer-today">  २०७७ - असार - १६ मंगल</strong></div>
                <div class="cal-foot-right">
                    <div class="cal-copy"> <a href="https://youtube.com/@bimalsirg">©BimalSirG YouTube</a> </div>
                </div>
            </div>
        </div>
`;
...
class NepaliCalendar extends HTMLElement {
  constructor() {
    ...
    if (this.getAttribute("style") != null) this.shadowRoot.querySelector('link').href = this.getAttribute("style");
...
this.shadowRoot.querySelectorAll(".footer-time").forEach((elem) => {
  setInterval(() => {
    ...
    // Create the formatted time string with color styling
    let formattedTime = `<span style="color: red;">${time
      .getHours()
      .toString()
      .padStart(2, 0)}:${time
      .getMinutes()
      ...
      .getSeconds()
      .toString()
      .padStart(2, 0)}</span> <span style="color: blue;">${suffix}</span>`;

    // Update the innerHTML with the formatted string
    elem.innerHTML = formattedTime;

    // Convert the time to English digits (assuming the function exists)
    elem.innerHTML = elem.innerHTML.toString().toEnglishDigits();
  }, 100);
});
